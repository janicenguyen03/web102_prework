...
const totalContributions = GAMES_JSON.reduce( (contributors, game) => {
    return contributors + game.backers;
}, 0);
...
const unfundedStr = 
    ...
    ${numUnfundedGames} 
    ${numUnfundedGames.length > 1 ? "games remain" : "game remains"} unfunded.
